...
import com.autoparts.ms.maintenance.constants.PartyCode;

/**
 * @author sosseres
 *
 */
public class PartyCodeConstraintValidator implements ConstraintValidator<PartyCodeConstraint, String>{
	
	private static List<String> options = Arrays.stream(PartyCode.values())
	 ...
	 * 
	 */
	private PartyCodeConstraintValidator() {
